# Django settings for heap_todo project.
...
SECRET_KEY = 'h44x9!*)rpdab(w$(zuqp$9b&amp;s)kol^(8vvqtj)=d90kxm0u+d'
...
ROOT_URLCONF = 'heap_todo.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'heap_todo.wsgi.application'
